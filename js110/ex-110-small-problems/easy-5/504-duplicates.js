...
function findDup(arr) {
  /*
  0. All elements are numbers in the array
  1. select an element from the array in sequence
  2. check if the element repeats in the array
  3. if yes, it is the repeated element
  4. Since only one element repeats, we can break the loop here
  */
