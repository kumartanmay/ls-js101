...
Instead, it uses concepts you learned earlier in the book. If you can't figure out the answer, don't worry:
...
There are other ways to detect a -0 value. Without using Object.is, write a function that will return true 
...
function isNegativeZero (value) {
  let num = 6;
  if((num / value) === -Infinity) return true;
  return false;
}
